  ...
  return (
    <main className="min-h-screen bg-white py-20 px-6">
      <div className="max-w-3xl mx-auto">
        {/* ヘッダー部分 */}
        <div className="mb-20">
          <Link href="/" className="text-xs text-gray-400 hover:text-[#b28c6e] flex items-center mb-10 transition-colors">
            <span className="mr-2">←</span> BACK TO HOME
          </Link>
          <h2 className="text-[10px] text-[#b28c6e] font-bold tracking-[0.3em] mb-4">ABOUT THIS PROJECT</h2>
          <h1 className="text-4xl font-bold text-gray-900 tracking-tight">このサイトについて</h1>
        </div>
        ...
        <div className="space-y-24 text-gray-600">
          <section className="leading-loose">
            <p className="text-lg text-gray-800 mb-6">
              本サイトは、ストグラに登場する「暦家」の活動を応援・記録するための<strong className="text-gray-900 border-b-2 border-[#b28c6e]/20">非公式ポータルサイト</strong>です。
            </p>
            <p className="text-sm">
              個人が趣味の範囲で運営しており、各配信者様および運営様とは一切関係ありません。
            </p>
          </section>
          ...
          <section className="relative py-12 px-8 md:px-12 bg-[#fdfaf8] rounded-[2.5rem] border border-[#f5ece5]">
            ...
            <ul className="space-y-8 text-sm md:text-[15px]">
              <li className="flex gap-4">
                ...
                <p><span className="font-bold text-gray-800">更新について：</span> 個人が手動で更新しているため、反映には時間がかかります。また、情報の正確性は保証いたしかねます。</p>
              </li>
              <li className="flex gap-4">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 p-8 md:p-10 bg-[#f8f9fa] rounded-[2rem] border border-gray-100">
              ...
              <div className="flex items-center bg-white p-5 rounded-2xl shadow-sm border border-gray-50 min-w-[280px]">
                ...
                <a 
                  ...
                  className="bg-[#4eb0f0] hover:bg-[#399ede] text-white text-[11px] font-bold px-4 py-2.5 rounded-xl flex items-center transition-all ml-4"
                >
        ...
        <footer className="mt-24 text-center">
          <p className="text-[10px] text-gray-300 tracking-[0.2em]">© {new Date().getFullYear()} KOYOMI-KE PROJECT</p>
        </footer>
      </div>
    </main>
  );
